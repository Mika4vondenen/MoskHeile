          ...
          <div>
             ...
             <div className="space-y-4 sm:space-y-6 mb-8 sm:mb-12">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div><h4 className="font-semibold text-gray-300 mb-1 text-sm sm:text-base">WhatsApp</h4><a href="https://wa.me/49176476972299" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#f59e0b] text-xs sm:text-sm">Chat starten</a></div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
